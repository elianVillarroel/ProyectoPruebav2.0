...
export class EventoController {
   ...
   async create(@Body() dto1:EventoDto1)
   {
      ...
      const costito = espacio.costo + dto1.capacidad_personas * 2 + (dto1.hora_fin - dto1.hora_inicio) * 10;
      const dto: EventoDto ={
         nombre : dto1.nombre,
...
/*
   ...
   @Delete('eliminar-res')
   async deleteReserva(@Body() body: {id: number}) 
   {
      const {id} = body;
      return await this.reservaservice.deleteRes(id);
   }  
